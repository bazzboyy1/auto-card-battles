...
**Phase:** Phase 33-B.0 "RunLog telemetry refresh + digest tool" shipped (v0.55, 2026-05-02). Captures Phase 27–33 features (modifier, rival, card tags) the legacy logger missed; new `scripts/digest_runlog.js` condenses a verbose 9k-line raw log into a ~95-line analysis-ready Markdown digest. Unblocks Phase 33-B's actual playtest read.
