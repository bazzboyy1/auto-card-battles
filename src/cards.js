...
const CARD_DEFS = [
  ...
  },
  {
    ...
    passive: {
      description: '+40 each when paired with Vorzak. Else +12 per adjacent neighbor.',
      axis: 'adjacency',
  ...
  },
  {
    ...
    passive: {
      description: 'Inactive rounds 1–5. +50% score from round 6+. +50 each when paired with Vexborg.',
      axis: 6,
      eval(card, ctx) {
